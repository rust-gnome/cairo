...
use enums::{Status, Antialias, LineCap, LineJoin, FillRule, FontSlant, FontWeight, TextClusterFlags,
            FontType, SubpixelOrder, HintStyle, HintMetrics, Extend, Filter, PathDataType,
            PatternType, Format, SurfaceType, Operator};
...
pub type cairo_read_func_t = Option<unsafe extern "C" fn(*mut c_void, *mut c_uchar, c_uint)
                                                         -> Status>;
pub type cairo_write_func_t = Option<unsafe extern "C" fn(*mut c_void, *mut c_uchar, c_uint)
                                                          -> Status>;
...
extern "C" {
    ...
    pub fn cairo_set_source_rgba(cr: *mut cairo_t,
                                 red: c_double,
                                 green: c_double,
                                 blue: c_double,
                                 alpha: c_double);
    ...
    pub fn cairo_set_dash(cr: *mut cairo_t,
    ...
    pub fn cairo_clip_extents(cr: *mut cairo_t,
                              x1: *mut c_double,
                              y1: *mut c_double,
                              x2: *mut c_double,
                              y2: *mut c_double);
    ...
    pub fn cairo_fill_extents(cr: *mut cairo_t,
                              x1: *mut c_double,
                              y1: *mut c_double,
                              x2: *mut c_double,
                              y2: *mut c_double);
    ...
    pub fn cairo_mask_surface(cr: *mut cairo_t,
                              surface: *mut cairo_surface_t,
                              surface_x: c_double,
                              surface_y: c_double);
    ...
    pub fn cairo_stroke_extents(cr: *mut cairo_t,
                                x1: *mut c_double,
                                y1: *mut c_double,
                                x2: *mut c_double,
                                y2: *mut c_double);
    ...
    pub fn cairo_arc(cr: *mut cairo_t,
                     xc: c_double,
                     yc: c_double,
                     radius: c_double,
                     angle1: c_double,
                     angle2: c_double);
    pub fn cairo_arc_negative(cr: *mut cairo_t,
                              xc: c_double,
                              yc: c_double,
                              radius: c_double,
                              angle1: c_double,
                              angle2: c_double);
    pub fn cairo_curve_to(cr: *mut cairo_t,
                          x1: c_double,
                          y1: c_double,
                          x2: c_double,
                          y2: c_double,
    ...
    pub fn cairo_rectangle(cr: *mut cairo_t,
                           x: c_double,
                           y: c_double,
                           width: c_double,
                           height: c_double);
    ...
    pub fn cairo_rel_curve_to(cr: *mut cairo_t,
                              dx1: c_double,
                              dy1: c_double,
                              dx2: c_double,
                              dy2: c_double,
    ...
    pub fn cairo_path_extents(cr: *mut cairo_t,
                              x1: *mut c_double,
                              y1: *mut c_double,
                              x2: *mut c_double,
                              y2: *mut c_double);
    ...
    pub fn cairo_pattern_get_color_stop_rgba(pattern: *mut cairo_pattern_t,
                                             ...
                                             alpha: *mut c_double)
                                             -> Status;
    pub fn cairo_pattern_create_rgb(red: c_double,
                                    green: c_double,
                                    blue: c_double)
                                    -> *mut cairo_pattern_t;
    pub fn cairo_pattern_create_rgba(red: c_double,
                                     green: c_double,
                                     blue: c_double,
                                     alpha: c_double)
                                     -> *mut cairo_pattern_t;
    ...
    pub fn cairo_pattern_get_surface(pattern: *mut cairo_pattern_t,
                                     ...
                                     -> Status;
    pub fn cairo_pattern_create_linear(x0: c_double,
                                       y0: c_double,
                                       x1: c_double,
                                       y1: c_double)
                                       -> *mut cairo_pattern_t;
    pub fn cairo_pattern_get_linear_points(pattern: *mut cairo_pattern_t,
                                           ...
                                           y1: *mut c_double)
                                           -> Status;
    pub fn cairo_pattern_create_radial(cx0: c_double,
                                       cy0: c_double,
                                       radius0: c_double,
                                       cx1: c_double,
                                       cy1: c_double,
    ...
    pub fn cairo_mesh_pattern_set_control_point(pattern: *mut cairo_pattern_t,
                                                ...
                                                x: c_double,
                                                y: c_double);
    pub fn cairo_mesh_pattern_set_corner_color_rgb(pattern: *mut cairo_pattern_t,
                                                   corner_num: c_uint,
                                                   red: c_double,
                                                   green: c_double,
                                                   blue: c_double);
    pub fn cairo_mesh_pattern_set_corner_color_rgba(pattern: *mut cairo_pattern_t,
                                                    corner_num: c_uint,
                                                    red: c_double,
                                                    green: c_double,
                                                    blue: c_double,
    ...
    pub fn cairo_mesh_pattern_get_control_point(pattern: *mut cairo_pattern_t,
                                                ...
                                                y: *mut c_double)
                                                -> Status;
    pub fn cairo_mesh_pattern_get_corner_color_rgba(pattern: *mut cairo_pattern_t,
                                                    patch_num: c_uint,
                                                    corner_num: c_uint,
                                                    red: *mut c_double,
                                                    green: *mut c_double,
    ...
    pub fn cairo_region_create_rectangle(rectangle: *mut cairo_rectangle_int_t)
                                         -> *mut cairo_region_t;
    pub fn cairo_region_create_rectangles(rects: *mut cairo_rectangle_int_t,
                                          count: c_int)
                                          -> *mut cairo_region_t;
    ...
    pub fn cairo_region_get_extents(region: *mut cairo_region_t,
                                    extents: *mut cairo_rectangle_int_t);
    pub fn cairo_region_num_rectangles(region: *mut cairo_region_t) -> c_int;
    pub fn cairo_region_get_rectangle(region: *mut cairo_region_t,
                                      nth: c_int,
                                      rectangle: *mut cairo_rectangle_int_t);
    pub fn cairo_region_is_empty(region: *mut cairo_region_t) -> cairo_bool_t;
    pub fn cairo_region_contains_point(region: *mut cairo_region_t,
                                       x: c_int,
                                       y: c_int)
                                       -> cairo_bool_t;
    //enum                cairo_region_overlap_t;
    pub fn cairo_region_contains_rectangle(region: *mut cairo_region_t,
                                           rectangle: *mut cairo_rectangle_int_t)
    ...
    pub fn cairo_glyph_extents(cr: *mut cairo_t,
                               glyphs: *const Glyph,
                               num_glyphs: c_int,
                               extents: *mut TextExtents);
    pub fn cairo_toy_font_face_create(family: *const c_char,
                                      slant: FontSlant,
                                      weight: FontWeight)
    ...
    */
    ...
    //                    TextExtents;
    pub fn cairo_scaled_font_text_extents(scaled_font: *mut cairo_scaled_font_t,
                                          utf8: *mut c_char,
                                          extents: *mut TextExtents);
    pub fn cairo_scaled_font_glyph_extents(scaled_font: *mut cairo_scaled_font_t,
                                           glyphs: *mut Glyph,
                                           num_glyphs: c_int,
                                           extents: *mut TextExtents);
    pub fn cairo_scaled_font_text_to_glyphs(scaled_font: *mut cairo_scaled_font_t,
                                            x: c_double,
                                            y: c_double,
                                            utf8: *mut c_char,
                                            utf8_len: c_int,
                                            ...
                                            cluster_flags: *mut TextClusterFlags)
                                            -> Status;
    pub fn cairo_scaled_font_get_font_face(scaled_font: *mut cairo_scaled_font_t)
                                           -> *mut cairo_font_face_t;
    pub fn cairo_scaled_font_get_font_options(scaled_font: *mut cairo_scaled_font_t,
                                              options: *mut cairo_font_options_t);
    pub fn cairo_scaled_font_get_font_matrix(scaled_font: *mut cairo_scaled_font_t,
                                             font_matrix: *mut Matrix);
    pub fn cairo_scaled_font_get_ctm(scaled_font: *mut cairo_scaled_font_t, ctm: *mut Matrix);
    pub fn cairo_scaled_font_get_scale_matrix(scaled_font: *mut cairo_scaled_font_t,
    ...
    pub fn cairo_font_options_copy(original: *mut cairo_font_options_t)
    ...
    pub fn cairo_font_options_merge(options: *mut cairo_font_options_t,
                                    other: *mut cairo_font_options_t);
    pub fn cairo_font_options_hash(options: *mut cairo_font_options_t) -> c_ulong;
    pub fn cairo_font_options_equal(options: *mut cairo_font_options_t,
                                    other: *mut cairo_font_options_t)
                                    -> cairo_bool_t;
    pub fn cairo_font_options_set_antialias(options: *mut cairo_font_options_t,
                                            antialias: Antialias);
    pub fn cairo_font_options_get_antialias(options: *mut cairo_font_options_t) -> Antialias;
    pub fn cairo_font_options_set_subpixel_order(options: *mut cairo_font_options_t,
                                                 subpixel_order: SubpixelOrder);
    pub fn cairo_font_options_get_subpixel_order(options: *mut cairo_font_options_t)
                                                 -> SubpixelOrder;
    pub fn cairo_font_options_set_hint_style(options: *mut cairo_font_options_t,
                                             hint_style: HintStyle);
    pub fn cairo_font_options_get_hint_style(options: *mut cairo_font_options_t) -> HintStyle;
    pub fn cairo_font_options_set_hint_metrics(options: *mut cairo_font_options_t,
    ...
    pub fn cairo_matrix_init(matrix: *mut Matrix,
                             xx: f64,
                             yx: f64,
                             xy: f64,
                             yy: f64,
    ...
    // CAIRO IMAGE SURFACE
    pub fn cairo_image_surface_create(format: Format,
                                      width: c_int,
                                      height: c_int)
                                      -> *mut cairo_surface_t;
    pub fn cairo_image_surface_create_for_data(data: *mut u8,
                                               format: Format,
                                               width: c_int,
                                               height: c_int,
                                               stride: c_int)
